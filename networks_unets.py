...
class wide_conv_block(nn.Module):
    def __init__(self,ch_in,ch_out):
        super(wide_conv_block,self).__init__()
        self.conv = nn.Sequential(
            nn.Conv2d(ch_in, ch_out, kernel_size=41,stride=1,padding=20,bias=True),
...
class AttU_Net(nn.Module):
    def __init__(self,img_ch=3,output_ch=1):
        ...
        # self.wideConv1 = wide_conv_block(ch_in=img_ch,ch_out=16)
        # self.wideConv2 = wide_conv_block(ch_in=16,ch_out=32)
        # self.wideConv3 = wide_conv_block(ch_in=32,ch_out=64)
        # self.wideConv4 = wide_conv_block(ch_in=64,ch_out=128)
        # self.wideConv5 = wide_conv_block(ch_in=128,ch_out=256)
